    ...
    return (
        <div className="withdraw px-[15px] py-[20px] min-h-[920px] bg-[#f2f2f2]">
            <div className="bg-[#fff] text-2xl rounded-2xl py-4 px-4 leading-10">
                {/* <span>Trung tâm thương mại Indochina Mall</span>
                <br />
                <br />
                <span>
                    Indochina Mall là điểm đến “tất cả trong một” dành cho mọi đối tượng khách hàng, đặc biệt là gia đình,
                    phù hợp cho cả người Việt Nam và người nước ngoài tại thành phố Hồ Chí Minh. Nằm dọc theo đại lộ
                    Nguyễn Văn Linh, Quận 7, Indochina Mall gồm năm tầng cung cấp các sản phẩm thời trang mới nhất, đại
                    siêu thị, hệ thống rạp phim, cũng như các cửa hàng ăn uống, giải trí, giáo dục, phong cách sống.
                </span>
                <br />
                <br />
                <span>
                    Indochina Mall được liên doanh phát triển bởi Công ty Cổ phần Đầu tư Phát triển Saigon Co.op (SCID) và
