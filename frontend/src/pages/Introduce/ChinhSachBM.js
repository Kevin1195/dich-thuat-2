        ...
        <div className="withdraw px-[15px] py-[20px] min-h-[920px] bg-[#f2f2f2]">
            <div className="bg-[#fff] text-2xl rounded-2xl py-4 px-4 leading-10">
                ...
                <span>
                    ...
                    đích giúp người dùng hiểu rõ những thông tin mà Công ty TNHH Bigben Việt Nam (Sau đây gọi là
                    “Bigben Vietnam” hoặc “chúng tôi”) thu thập và đảm bảo an toàn thông tin cá nhân cho người dùng
                    khi truy cập và/hoặc sử dụng ứng dụng di động của công ty TNHH Bigben Việt Nam (“Ứng dụng điện
                    thoại của Bigben Vietnam”). Người dùng có trách nhiệm thông báo kịp thời cho chúng tôi về những
                    hành vi sử dụng trái phép, lạm dụng, vi phạm bảo mật của bên thứ ba về việc sử dụng Ứng dụng điện
                    thoại của Bigben Vietnam để có biện pháp giải quyết phù hợp.
                </span>
                <br />
                <br />
                <span>
                ...
                <br />
                <span>
                    Người dùng khi sử dụng Ứng dụng điện thoại của Bigben Vietnam có thể được yêu cầu cung cấp các
                    ...
                    không chiu trách nhiệm trong những trường hợp đó. Bigben Vietnam sử dụng thông tin người dùng
                ...
                <br />
                <span>
                    • Gửi các thông báo về các hoạt động trao đổi thông tin giữa người dùng và Bigben Vietnam để
                    người dùng theo dõi quá trình trao đổi thông tin này và để thông báo rằng Bigben Vietnam đã ghi
                ...
                <br />
                <span>
                    • Xác nhận và liên hệ có liên quan đến giao dịch tại Ứng dụng đi động của Bigben Vietnam.
                </span>
                <br />
                <span>
                    • Để gửi đến người dùng các thông tin về chương trình khuyến mại, hoạt động, sự kiện đang và sắp
                    diễn ra, nghiên cứu, khảo sát của Bigben Vietnam và/ hoặc bên liên kết và/ hoặc đối tác của
                ...
                <br />
                <span>
                    Bigben Việt Nam có trách nhiệm hợp tác cung cấp thông tin cá nhân của người dùng khi có yêu cầu
                    ...
                    Bigben Vietnam. Thông tin có thể được chia sẻ cho bên thứ ba mà chúng tôi hợp tác để phát triển
                    Ứng dụng di động của Bigben Việt Nam. Tuy nhiên, trong trường hợp này, chúng tôi sẽ cố gắng để
                ...
                <span>
                    ...
                    trên máy chủ của Bigben MALL Vietnam và máy chủ của Chương trình Khách hàng Thân thiết
                    Bigben MALL Vietnam. Người dùng có quyền sử dụng các dịch vụ và tiện ích đươc cung cấp bởi Ứng
                    dụng di động của Bigben Vietnam, thay đổi, cập nhật, xóa bỏ thông tin cá nhân đã cung cấp trên
                    hệ thống dữ liệu của Ứng dụng di động của Bigben Vietnam bằng cách đăng nhập vào tài khoản cá
                    nhân. Người dùng có quyền gửi khiếu nại đến địa chỉ website https://Bigben.com hoặc thông qua
                    Ứng dụng di động của Bigben Vietnam. Khi tiếp nhận những phản hồi này, chúng tôi sẽ xác nhận
                    lại thông tin; trường hợp đúng như phản ánh của người dùng, tùy theo mức độ, Bigben Việt Nam sẽ
                ...
                <br />
                <span>
                    Ứng dụng điện thoại của Bigben Vietnam có thể chứa đường liên kết đến các trang web, ứng dụng
                    của bên thứ ba và dịch vụ trực tuyến không do Bigben Vietnam sở hữu hoặc kiểm soát. Bigben
                    Vietnam không kiểm soát và không có trách nhiệm đối với những trang web và ứng dụng trực tuyến này.
                    Hãy lưu ý khi rời khỏi Ứng dụng di động của Bigben. Người dùng được khuyến nghị đọc kỹ các điều
                ...
                <br />
                <span>
                    - Ứng dụng điện thoại của Bigben Vietnam có các trò chơi ngắn bao gồm Lucky wheel, Quiz game và
                ...
                <br />
                <span>CÔNG TY TNHH Bigben VIỆT NAM</span>
                <br />
                <span>
                    Địa chỉ: Tầng 3, Văn phòng phía Đông, Bigben Long Biên, số 27 đường Cổ Linh, Phường Long Biên,
                    Quận Long Biên, Thành phố Hà Nội, Việt Nam
                </span>
                <br />
                <br />
                <span>Email: nbs@Bigben-vn.com</span>
                <br />
                <span>Bigben VIETNAM CO., LTD</span>
                <br />
                <br />
                <span>
                ...
                <br />
                <span>
                    Thông tin cá nhân của khách hàng trên Ứng dụng di động Bigben Vietnam được cam kết bảo mật
                    ...
                    dẫn đến mất mát dữ liệu cá nhân người dùng, Bigben Vietnam sẽ có trách nhiệm thông báo vụ việc
                    cho cơ quan chức năng điều tra xử lý kịp thời và thông báo cho người dùng được biết. Để Ban quản lý
                    Bigben Việt Nam có thể giải quyết các yêu cầu/khiếu nại của các cá nhân/tổ chức thì khi liên hệ
                    với chúng tôi, người dùng vui lòng cung cấp đầy đủ thông tin cá nhân có liên quan như: Họ và tên,
                    địa chỉ liên lạc, điện thoại… và chịu trách nhiệm về những thông tin trên. Ban quản lý Bigben
