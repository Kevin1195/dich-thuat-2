...
export const gridOrderStatus = (props) => (
  <button
    ...
    className="text-white p-1 capitalize rounded-2xl text-[12px]"
  >
    {props.status === 1
      ? "Thành công"
      : props.status === 2
...
export const gridOrderStatus2 = (props) => {
  return (
    <button
      ...
      className="text-white p-1 capitalize rounded-2xl text-[12px]"
    >
      {props.lastLogin === 1 ? "Online" : "Offline"}
    </button>
  );
};
...
export const userStatus = (props) => {
  return (
    <button
      type="button"
      style={{
        background: `${props.invite != 666666 ? "#2ecc71" : "#e74c3c"}`,
      }}
      className="text-white p-1 capitalize rounded-2xl text-[12px]"
    >
      {props.invite != 666666 ? "Người thật" : "Người giả"}
    </button>
  );
};
...
export const ordersData = [
  {
    ...
    NameProduct: "Fresh Tomato ",
    Level: "vip3",
    Price: 9123293,
    Roses: 12412,
    IdMission: "UWGUWDBGUWGBUDH297",
    Active: "2020-10-06 12:03:05",
  },
];
...
export const membersGrid = [
  ...
  {
    field: "may_man",
    headerText: "Hộp quà may mắn",
    textAlign: "Center",
    width: "130",
  },
  {
    field: "thue_may_man",
    headerText: "Thuế may mắn",
    textAlign: "Center",
    width: "130",
  },
  {
...
export const levelGrid = [
  ...
  {
    field: "name_level",
    headerText: "Tên cấp độ",
    width: "150",
    textAlign: "Center",
  },
  {
    field: "price",
    headerText: "Số tiền đầu tư",
    format: "N2",
    textAlign: "Center",
    editType: "numericedit",
    width: "150",
  ...
  {
    field: "amount",
    headerText: "Số đơn hàng trong ngày",
    textAlign: "Center",
    width: "150",
  },
  {
  ...
  {
    field: "withdraw_per_day",
    headerText: "Số lượt rút tiền trong ngày",
    textAlign: "Center",
    width: "150",
  },
  {
    field: "time",
    template: ActiveLevel,
    headerText: "Thao tác",
    width: "150",
    textAlign: "Center",
  },
...
export const ordersGrid4 = [
  ...
  {
    field: "time",
    template: AcctionOrderX,
    headerText: "Thao tác",
    width: "150",
    textAlign: "Center",
  },
];
export const ordersGrid2_2 = [
  {
    field: "username",
    headerText: "Tài khoản",
    width: "150",
