        ...
        <div className="withdraw px-[15px] py-[20px] min-h-[920px] bg-[#f2f2f2]">
            <div className="bg-[#fff] text-2xl rounded-2xl py-4 px-4 leading-10">
                ...
                <span>
                    ...
                    ngắn sẽ được tuân thủ theo chính sách bảo mật thông tin này.
                </span>
                <br />
                <span>
                ...
                <span>
                    ...
                    sử dụng, không chuyển giao, cung cấp hay tiết lộ cho bên thứ 3 nào về thông tin cá nhân của người
