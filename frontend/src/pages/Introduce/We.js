    ...
    return (
        <div className="withdraw px-[15px] py-[20px] min-h-[920px] bg-[#f2f2f2]">
            <div className="bg-[#fff] text-2xl rounded-2xl py-4 px-4 leading-10">
                <span>LOTTE YOUNG PLAZA</span>
                <br />
                <br />
                <span>
                    LOTTE YOUNG PLAZA Việt Nam - nhà bán lẻ hàng đầu của Nhật Bản và châu Á - đã tạo được sự hiện diện
                    mạnh mẽ tại Việt Nam từ năm 2011. Tại Công ty LOTTE YOUNG PLAZA, tập trung vào khách hàng là triết
                ...
                <br />
                <br />
                <span>Các Trung tâm mua sắm của chúng tôi tại LOTTE YOUNG PLAZA:</span>
                <br />
                <br />
                <span>1. ĐỊA CHỈ: Địa chỉ 67, Namdaemun-ro, Jung-gu, Seoul</span>
                <br />
                <br />
                ...
                <br />
                <span>
                    @2023 - Bản quyền của LOTTE YOUNG PLAZA Giấy chứng nhận đăng ký kinh doanh số 0317601810 do Sở Kế
